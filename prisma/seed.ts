...
title: "SignalFlow",
shortDescription:
"An AI-powered customer feedback intelligence platform that transforms raw feedback into structured topics, sentiment trends, feature requests, and evidence-backed product insights.",
description:
"SignalFlow is a multi-tenant AI feedback intelligence SaaS for helping product teams understand large volumes of customer feedback from sources such as support tickets, surveys, reviews, and CSV imports. The platform processes raw feedback through asynchronous AI workflows that classify sentiment, category, severity, and topic while preserving the original customer message as the source of truth. Deterministic analytics calculate feedback volume, sentiment distribution, topic trends, growth rates, and emerging issues, while AI is used to explain verified data rather than invent product metrics. SignalFlow combines organization and project workspaces, background processing, semantic search, topic intelligence, evidence-backed AI insights, feature request tracking, and a modern dark-mode analytics dashboard into one production-style SaaS application.",
...
features: [
"Organization-based multi-tenant workspaces",
"Independent project workspaces for different products",
"CSV customer feedback import",
"CSV validation, preview, and column mapping",
"Asynchronous feedback processing",
"AI-powered sentiment classification",
"Feedback category and severity detection",
"AI-assisted topic extraction",
"Customer feedback inbox with filtering and search",
"Topic intelligence with supporting customer feedback",
"Deterministic feedback volume and trend analytics",
"Sentiment distribution and historical analytics",
"Emerging issue detection based on verified trend calculations",
"Feature request identification and ranking",
"Evidence-backed AI insight generation",
"Semantic feedback search using embeddings and pgvector",
"Role-based organization access",
"Usage tracking for SaaS plan enforcement",
"Modern dark-mode analytics dashboard with a green visual system",
"Colorful data visualizations for topics, trends, sentiment, and severity",
],
lessonsLearned: [
"AI-generated analysis should be treated as untrusted input and validated against a strict structured schema before it is persisted.",
"Customer feedback and AI-generated interpretation should remain separate so the original message is always preserved as the source of truth.",
"Product metrics such as counts, percentages, growth rates, and trend detection should be calculated deterministically instead of generated by an LLM.",
"AI insights are more trustworthy when every summary can be traced back to supporting feedback records and verified analytics.",
"Multi-tenant SaaS systems require organization-scoped authorization at every data-access boundary rather than relying only on authentication.",
"Long-running AI classification and embedding generation should run in background workers instead of blocking request handlers.",
"Semantic search and relational filtering serve different purposes and work best when combined rather than replacing one another.",
"Dashboard color should communicate data meaning while the core application shell remains visually consistent and restrained.",
],
challenge:
"Building an AI feedback intelligence platform requires coordinating several complex boundaries at once: multi-tenant authorization, large feedback imports, asynchronous AI processing, structured model output, semantic search, deterministic analytics, and evidence-backed insight generation. Raw AI responses can be malformed or inaccurate, and allowing the model to calculate statistics directly could create misleading analytics. The system also needs to process large numbers of feedback records without blocking the user experience while guaranteeing that every query, vector search, topic, and insight remains isolated to the correct organization and project.",
solution:
"SignalFlow separates AI interpretation from application correctness. Next.js and TypeScript provide the application layer, while Prisma and PostgreSQL store organizations, projects, source feedback, structured analysis, topics, insights, and usage records. AI workflows classify and summarize customer language through validated structured outputs, and pgvector stores embeddings for semantic similarity search. Long-running classification and embedding operations run through background workers, while deterministic services calculate feedback counts, sentiment percentages, historical comparisons, topic growth, and emerging issue thresholds. Organization-scoped queries, role-based authorization, schema validation, explicit job states, and evidence relationships ensure that AI-generated insights remain traceable to real customer feedback and verified product data.",
thumbnail: "/signalflow-preview.png",
images: [],
videoUrl: null,
